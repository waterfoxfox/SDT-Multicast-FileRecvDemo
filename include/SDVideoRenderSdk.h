...
* @return: TRUE成功，FALSE失败
*/
DLLIMPORT_VIDEO_RENDER BOOL SDVideoRender_UpdateTheStreamRenderParams(void* pVideoRender, unsigned int unStreamId, unsigned int unZOrder, float fLeft, float fTop, float fRight, float fBottom);


/***
* 过程中调整全局渲染位置属性(画面在窗口中的渲染位置)
* @param pVideoRender: 模块指针
* @param: nLeft 画面在窗口中的相对位置，左坐标
* @param: nTop 画面在窗口中的相对位置，上坐标
* @param: nRight 画面在窗口中的相对位置，右坐标
* @param: nBottom 画面在窗口中的相对位置，下坐标
* @return: TRUE成功，FALSE失败
*/
DLLIMPORT_VIDEO_RENDER BOOL SDVideoRender_UpdateRenderRectParams(void* pVideoRender, int nLeft, int nTop, int nRight, int nBottom);
...
* @return: TRUE成功，FALSE失败
*/
DLLIMPORT_VIDEO_RENDER void SDVideoRender_RemoveTheStream(void* pVideoRender, unsigned int unStreamId);
...
* @return: TRUE成功，FALSE失败
*/
DLLIMPORT_VIDEO_RENDER void SDVideoRender_RemoveStreams(void* pVideoRender);
